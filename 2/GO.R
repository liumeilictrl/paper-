...
kk=enrichGO(gene = gene, OrgDb = org.Hs.eg.db, pvalueCutoff = 1, qvalueCutoff = 1, ont="all", readable = T)  # 进行GO富集分析
GO=as.data.frame(kk)  
...
pdf(file="barplot.pdf", width = 9, height = 15)  
...
pdf(file="bubble.pdf", width = 9, height = 15)  
